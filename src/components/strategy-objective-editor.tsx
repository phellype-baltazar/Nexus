...
export function StrategyObjectiveEditor({objective,groups}:{objective:any;groups:any[]}){
  ...
  if(!open)return <button className="btn btn-outline" aria-label="Editar objetivo" title="Editar objetivo" style={{padding:0,width:38,height:38,minWidth:38,borderRadius:12,fontSize:18,lineHeight:1}} onClick={()=>setOpen(true)}>✎</button>;
